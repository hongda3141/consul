...
This page describes how to federate multiple Kubernetes clusters.

## Primary Datacenter

In order to federate clusters, one cluster must be designated the
primary datacenter. This cluster will be
responsible for creating the certificate authority that will be used to encrypt
Connect traffic. It also handles validating global ACL tokens. All other clusters
...
consul-server-0.dc1  10.32.4.216:8302     alive   server  1.7.0dev  2         dc1  <all>
consul-server-0.dc2  192.168.2.173:8302   alive   server  1.7.0dev  2         dc2  <all>
consul-server-1.dc1  10.32.5.161:8302     alive   server  1.7.0dev  2         dc1  <all>
consul-server-1.dc2  192.168.88.64:8302   alive   server  1.7.0dev  2         dc2  <all>
consul-server-2.dc1  10.32.1.175:8302     alive   server  1.7.0dev  2         dc1  <all>
consul-server-2.dc2  192.168.35.174:8302  alive   server  1.7.0dev  2         dc2  <all>
```
