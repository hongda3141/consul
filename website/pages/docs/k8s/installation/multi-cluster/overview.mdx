...
- [Intentions](/docs/connect/intentions) can be used to enforce cross-cluster rules about which services can communicate.
...
network. In the Kubernetes context this is often unachievable. It would require that
...
subnets that other clusters cannot .
